        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (mFirebaseUser != null) {
                    ...
                    Intent i = new Intent(com.example.studentregister.LoginActivity.this, RegisterActivity.class);
                    startActivity(i);
                } else {
                    ...
                    mFirebaseAuth.signInWithEmailAndPassword(email, pwd).addOnCompleteListener(com.example.studentregister.LoginActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (!task.isSuccessful()) {
                                ...
                                Intent intToHome = new Intent(com.example.studentregister.LoginActivity.this, RegisterActivity.class);
